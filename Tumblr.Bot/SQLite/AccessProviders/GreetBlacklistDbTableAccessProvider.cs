...
{
    internal class GreetBlacklistDbTableAccessProvider :
        SQLiteDbTableAccessProvider<BlacklistItemEntity, int?>
    {
        public GreetBlacklistDbTableAccessProvider(
            string dbFileName,
            string tableName,
        ...
        public async Task<bool> ContainsItemAsync(string item)
        {
            ...
            var result = await Connection.QueryFirstOrDefaultAsync<BlacklistItemEntity>(
                query,
                obj
